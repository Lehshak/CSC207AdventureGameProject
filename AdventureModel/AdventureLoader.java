...
public class AdventureLoader {
     ...
     */
    public AdventureLoader(AdventureGame game, String directoryName, Player player) {
        this.game = game;
    ...
    private void parseRooms() throws IOException {
        ...
        while (buff.ready()) {
            ...
            // check if this room is a fight zone
            // -- if so, start the fight and add results to room description
